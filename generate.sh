...
for file in data/*-database.txt; do
	...
	python scripts/category-json.py "data/${version}-database.txt" "${version}" &
...
for file in data/*-properties.txt; do
	...
	python scripts/property-json.py "data/${version}-properties.txt" "${version}" &
...
for file in data/*-scripts.txt; do
	...
	python scripts/script-json.py "data/${version}-scripts.txt" "${version}" &
...
for file in data/*-blocks.txt; do
	...
	python scripts/block-json.py "data/${version}-blocks.txt" "${version}" &
